...
!> Returns true if any unit tests for module LND_diag_vkernels fail
logical function diag_vkernels_unit_tests(verbose)
  ...
  write(stdout,*) '==== LND_diag_kernels: diag_vkernels_unit_tests =========='
