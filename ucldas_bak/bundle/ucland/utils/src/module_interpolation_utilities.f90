...
real(kind=kind_phys), dimension(vector_length)    :: interp_var
...
integer                           :: vector_length
real(kind=kind_phys), dimension(vector_length)    :: last_var, next_var, interp_var
...
real, dimension(vector_length)    :: latitude, longitude
real(kind=kind_phys), dimension(vector_length)    :: last_var, interp_var

double precision                  :: calc_time
real(kind=kind_phys), dimension(vector_length)    :: cosz1, cosz2, cosz3, coszavg, cosz
