...
private
public :: ucldas_kst, ucldas_soft_jacobian
...
!==========================================================================
subroutine ucldas_soft_jacobian (jac, t, s, h, dsdtmax, dsdzmin, dtdzmin)
  !==========================================================================
  !
  ...
  call ucldas_diff(dtdz,t,h)
  call ucldas_diff(dsdz,s,h)
...
end subroutine ucldas_soft_jacobian

end module ucldas_kst_mod
