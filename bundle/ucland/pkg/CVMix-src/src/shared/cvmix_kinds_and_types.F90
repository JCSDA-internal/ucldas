...
! !PUBLIC TYPES:
  ...
  type, public :: cvmix_data_type
    ...
    ! different coefficients for lndentum (Mdiff), temperature (Tdiff), and
    ...
    ! (non-temperature) tracers. Eventually may add support for lndentum terms
    ! (would be 2D for x- and y-, respectively) but current implementation
    ! assumes lndentum term is 0 everywhere.
