...
use LND_error_handler, only : LND_mesg, LND_error, FATAL
...
subroutine DOME2d_initialize_thickness ( h, G, GV, US, param_file, just_read_params )
  ...
  if (.not.just_read) &
    call LND_mesg("LND_initialization.F90, DOME2d_initialize_thickness: setting thickness")
 ...
 !    enddo ; enddo
    ...
    case default
      call LND_error(FATAL,"dome2d_initialize: "// &
