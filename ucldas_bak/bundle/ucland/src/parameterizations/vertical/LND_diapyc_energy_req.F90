...
module LND_diapyc_energy_req

! This file is part of UCLAND. See LICENSE.md for the license.

!! \author By Robert Hallberg, May 2015

use LND_diag_mediator, only : diag_ctrl, Time_type, post_data, register_diag_field
...
use LND_EOS, only : calculate_specific_vol_derivs, calculate_density
...
!> This control structure holds parameters for the LND_diapyc_energy_req module
...
subroutine diapyc_energy_req_test(h_3d, dt, tv, G, GV, US, CS, Kd_int)
  ...
  if (.not. associated(CS)) call LND_error(FATAL, "diapyc_energy_req_test: "// &
...
#include "version_variable.h"
  character(len=40)  :: mdl = "LND_diapyc_energy_req" ! This module's name.
...
end module LND_diapyc_energy_req
