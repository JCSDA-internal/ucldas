...
use LND_domains, only : LND_domain_type, get_domain_extent, get_global_shape
...
subroutine hor_index_init(Domain, HI, param_file, local_indexing, index_offset)
  type(LND_domain_type),  intent(in)    :: Domain     !< The LND domain from which to extract information.
...
#include "version_variable.h"
  ...
  call log_version(param_file, "LND_hor_index", version, &
