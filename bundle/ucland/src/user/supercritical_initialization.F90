...
use LND_open_boundary,  only : ocean_OBC_type, OBC_NONE, OBC_SIMPLE, OBC_segment_type
...
subroutine supercritical_set_OBC_data(OBC, G, param_file)
  ...
  if (.not.associated(OBC)) call LND_error(FATAL, 'supercritical_initialization.F90: '// &
