...
#ifndef UCLDAS_MODELBIAS_MODELBIASCOVARIANCE_H_
#define UCLDAS_MODELBIAS_MODELBIASCOVARIANCE_H_
...
class ModelBiasCovariance : public util::Printable,
 ...
 public:
  static const std::string classname() {return "ucldas::ModelBiasCovariance";}
...
#endif  // UCLDAS_MODELBIAS_MODELBIASCOVARIANCE_H_
