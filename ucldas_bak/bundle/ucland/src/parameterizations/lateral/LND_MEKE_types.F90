...
type, public :: MEKE_type
  ...
  real, dimension(:,:), pointer :: &
    ...
    lnd_src => NULL(),& !< MEKE source from lateral friction in the lndentum equations [R Z L2 T-3 ~> W m-2].
    GME_snk => NULL(),& !< MEKE sink from GME backscatter in the lndentum equations [R Z L2 T-3 ~> W m-2].
