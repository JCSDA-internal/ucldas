...
type, public :: forcing_type
  ...
  real(kind=kind_phys), allocatable, dimension(:)  :: temperature
  real(kind=kind_phys), allocatable, dimension(:)  :: specific_humidity
  real(kind=kind_phys), allocatable, dimension(:)  :: surface_pressure
  real(kind=kind_phys), allocatable, dimension(:)  :: wind_speed
  real(kind=kind_phys), allocatable, dimension(:)  :: downward_longwave
  real(kind=kind_phys), allocatable, dimension(:)  :: downward_shortwave
  real(kind=kind_phys), allocatable, dimension(:)  :: precipitation
  real(kind=kind_phys)                             :: forcing_height
  ...
  real(kind=kind_phys), allocatable, dimension(:)  :: last_temperature
  real(kind=kind_phys), allocatable, dimension(:)  :: last_specific_humidity
  real(kind=kind_phys), allocatable, dimension(:)  :: last_surface_pressure
  real(kind=kind_phys), allocatable, dimension(:)  :: last_wind_speed
  real(kind=kind_phys), allocatable, dimension(:)  :: last_downward_longwave
  real(kind=kind_phys), allocatable, dimension(:)  :: last_downward_shortwave
  real(kind=kind_phys), allocatable, dimension(:)  :: last_precipitation
     
  double precision                 :: next_time
  character*19                     :: next_date  ! format: yyyy-mm-dd hh:nn:ss
  logical                          :: next_forcing_read
  real(kind=kind_phys), allocatable, dimension(:)  :: next_temperature
  real(kind=kind_phys), allocatable, dimension(:)  :: next_specific_humidity
  real(kind=kind_phys), allocatable, dimension(:)  :: next_surface_pressure
  real(kind=kind_phys), allocatable, dimension(:)  :: next_wind_speed
  real(kind=kind_phys), allocatable, dimension(:)  :: next_downward_longwave
  real(kind=kind_phys), allocatable, dimension(:)  :: next_downward_shortwave
  real(kind=kind_phys), allocatable, dimension(:)  :: next_precipitation
