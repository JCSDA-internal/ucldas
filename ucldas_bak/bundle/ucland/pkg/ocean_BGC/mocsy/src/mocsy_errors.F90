...
!    
!     It computes numerical derivatives then applies error propagation using the method of lndents.
!     The method of lndents is a very general technique for estimating the second lndent of a variable z
