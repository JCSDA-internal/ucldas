# -*- coding: utf-8 -*-
#
# UCLAND documentation build configuration file, created by
...
project = u'UCLAND'
copyright = u'2017, UCLAND developers'
...
latex_documents = [
  ('index', 'UCLAND.tex', u'UCLAND Documentation',
...
man_pages = [
    ('index', 'ucland', u'UCLAND Documentation',
...
texinfo_documents = [
  ('index', 'UCLAND', u'UCLAND Documentation',
   u'Alistair Adcroft, Robert Hallberg, Stephen Griffies, Matthew Harrison, Brandon Reichl, Niki Zadeh, John Krasting, Nic Hannah', 'UCLAND', 'One line description of project.',
   'Miscellaneous'),
]
