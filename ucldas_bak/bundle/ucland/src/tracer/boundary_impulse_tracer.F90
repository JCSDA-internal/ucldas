...
type, public :: boundary_impulse_tracer_CS ; private
  ...
  type(LND_restart_CS), pointer :: restart_CSp => NULL() !< A pointer to the retart control structure
...
#include "version_variable.h"
  ...
  if (associated(CS)) then
    call LND_error(WARNING, "register_boundary_impulse_tracer called with an "// &
...
!! The more commonly used ideal age tracer is the first lndent of the TTD, equivalently referred to as the
!! mean age.
!!
