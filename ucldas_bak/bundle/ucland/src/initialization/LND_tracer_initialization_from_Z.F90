...
module LND_tracer_initialization_from_Z
...
use LND_horizontal_regridding, only : myStats, horiz_interp_and_extrap_tracer
...
use LND_ALE, only : ALE_remap_scalar

implicit none ; private

#include <LND_memory.h>

public :: LND_initialize_tracer_from_Z
...
character(len=40)  :: mdl = "LND_tracer_initialization_from_Z" !< This module's name.

contains

!> Initializes a tracer from a z-space data file.
subroutine LND_initialize_tracer_from_Z(h, tr, G, GV, US, PF, src_file, src_var_nam, &
...
# include "version_variable.h"
  character(len=40)  :: mdl = "LND_initialize_tracers_from_Z" ! This module's name.
...
end subroutine LND_initialize_tracer_from_Z

end module LND_tracer_initialization_from_Z
