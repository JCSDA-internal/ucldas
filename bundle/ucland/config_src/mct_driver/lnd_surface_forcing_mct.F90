module LND_surface_forcing_mct
...
type, public :: surface_forcing_CS ; private
  ...
  type(LND_restart_CS), pointer :: restart_CSp => NULL() !< restart pointer
...
#include "version_variable.h"
  character(len=40)  :: mdl = "LND_surface_forcing_mct"  ! This module's name.
...
end module LND_surface_forcing_mct
