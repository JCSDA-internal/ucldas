...
#ifndef UCLDAS_MODELBIAS_MODELBIAS_H_
#define UCLDAS_MODELBIAS_MODELBIAS_H_
...
/// Model error for the UCLDAS model.
/*!
...
class ModelBias : public util::Printable,
 ...
 public:
  static const std::string classname() {return "ucldas::ModelBias";}
...
#endif  // UCLDAS_MODELBIAS_MODELBIAS_H_
