...
# include "version_variable.h"
  ...
  call LND_mesg("  Neverworld_initialization.F90, Neverworld_initialize_topography: setting topography", 5)
...
subroutine Neverworld_initialize_thickness(h, G, GV, US, param_file, eqn_of_state, P_ref)
  ...
  call LND_mesg("  Neverworld_initialization.F90, Neverworld_initialize_thickness: setting thickness", 5)
