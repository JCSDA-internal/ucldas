...
use LND_io,                 only : file_exists, read_data, slasher, vardesc, var_desc, query_vardesc
...
#include "version_variable.h"
  ...
  if (associated(CS)) then
    call LND_error(WARNING, "register_dye_tracer called with an "// &
  ...
  if (minval(CS%dye_source_minlon(:)) < -1.e29) &
    call LND_error(FATAL, "register_dye_tracer: Not enough values provided for DYE_SOURCE_MINLON ")
  ...
  if (minval(CS%dye_source_maxlon(:)) < -1.e29) &
    call LND_error(FATAL, "register_dye_tracer: Not enough values provided for DYE_SOURCE_MAXLON ")
  ...
  if (minval(CS%dye_source_minlat(:)) < -1.e29) &
    call LND_error(FATAL, "register_dye_tracer: Not enough values provided for DYE_SOURCE_MINLAT ")
  ...
  if (minval(CS%dye_source_maxlat(:)) < -1.e29) &
    call LND_error(FATAL, "register_dye_tracer: Not enough values provided for DYE_SOURCE_MAXLAT ")
  ...
  if (minval(CS%dye_source_mindepth(:)) < -1.e29*US%m_to_Z) &
    call LND_error(FATAL, "register_dye_tracer: Not enough values provided for DYE_SOURCE_MINDEPTH")
  ...
  if (minval(CS%dye_source_maxdepth(:)) < -1.e29*US%m_to_Z) &
    call LND_error(FATAL, "register_dye_tracer: Not enough values provided for DYE_SOURCE_MAXDEPTH ")
