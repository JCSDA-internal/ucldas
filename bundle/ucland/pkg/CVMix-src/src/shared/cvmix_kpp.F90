...
! !PUBLIC TYPES:
  ...
  type, public :: cvmix_kpp_params_type
    private
      ...
      ! For velocity scale function, _m => lndentum and _s => scalar (tracer)
...
!BOC
    ...
    select case (MatchTechnique)
      ...
      case DEFAULT
        ...
        !      cases:
        !      i) lndentum diffusivity (viscosity)
...
! !DESCRIPTION:
!  Computes the turbulent velocity scales for lndentum (\verb|w_m|) and scalars
