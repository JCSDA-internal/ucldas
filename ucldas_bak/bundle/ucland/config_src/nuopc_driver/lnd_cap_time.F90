...
!! dependency to build the LND cap.  The options here for setting
...
!! shared library.  For now we really want the LND cap to only
!! depend on LND and ESMF/NUOPC.
module LND_cap_time
