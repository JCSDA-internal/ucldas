...
!* This file is a part of LND.                                         *
!*                                                                     *
!* LND is free software; you can redistribute it and/or modify it and  *
!* are expected to follow the terms of the GNU General Public License  *
!* as published by the Free Software Foundation; either version 2 of   *
!* the License, or (at your option) any later version.                 *
!*                                                                     *
!* LND is distributed in the hope that it will be useful, but WITHOUT  *
...
use LND_ALE_sponge, only : set_up_ALE_sponge_vel_field
...
use LND_sponge, only : set_up_sponge_ML_density
...
! Local variables
  ...
  if (.not.file_exists(filename, G%Domain)) &
      call LND_error(FATAL, " RGC_initialize_sponges: Unable to open "//trim(filename))
